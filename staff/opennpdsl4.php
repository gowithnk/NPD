								...
								<table class="data-table-ten table stripe hover nowrap">
									...
									<tbody>
										...
										<?php 
											...
											$sql = "SELECT * FROM tblnpd JOIN l3npd ON tblnpd.NPDNumber = l3npd.NPDNumber WHERE tblnpd.Status=1 AND tblnpd.LevelStatus=3 AND l3npd.Status=1";
													...
													<tr>
														...
														<td>
															<div class="table-actions">
																<a href="opennpdl4.php?edit=<?php echo htmlentities($result->NPDNumber); ?>#l4" data-color="#265ed7">
