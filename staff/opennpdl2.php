							...
							<section>
								<form name="save" method="post">
									...
									<div class="row">
										<div class="col-lg-12">
											<div class="form-group">
												<label for="empRemark">L1 Employee Remark</label>
									...
									<div class="row">
										<div class="col-sm-12">
											<div class="form-group">
											<label for="hodRemark">L1 HOD Remark</label>
									...
									<div class="row">
										<div class="col-lg-12">
											<div class="form-group">
												<label for="empRemark2">Remark</label>
												<textarea id="empRemark2" name="empRemark2" placeholder="Mark your remarks here..." class="form-control" rows="2" ></textarea>
											</div>
										</div>
									</div>
									<div class="col-sm-12">
