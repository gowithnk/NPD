								...
								<div class="pb-10">
									<table class="data-table-ten table stripe hover nowrap">
										...
										<tbody>
											...
											WHERE tblnpd.Status=1 AND tblnpd.LevelStatus=3 AND l2npd.Status=1 AND l3npd.Status=1 ";
										...
										<div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<textarea id="hod1Remark" name="hod1Remark" class="form-control" rows="1" readonly></textarea>
												</div>
											</div>
										</div>
									</div>
	...
	<script>
		$(document).ready(function() {
			$(".modalV").click(function() {
				...
				$('#emp2Remark').val(data[27]);
				$('#emp2Name').html(data[28]);
				$('#hod2Remark').val(data[29]);
				$('#hod2Name').html(data[30]);
				$('#packingType').val(data[31]);
				$('#lFColour').val(data[32]);
				$('#baseFoil').val(data[33]);
				$('#pVCPVDC').val(data[34]);
				$('#changePart').val(data[35]);
				$('#empRemark').val(data[36]);
				$('#monoCarton').val(data[37]);
				$('#insert3').val(data[38]);
				$('#silicaGel').val(data[39]);
				$('#outerCarton').val(data[40]);
				$('#shrink').val(data[41]);
				$('#shipperSpecs').val(data[42]);
				$('#shipperPacking').val(data[43]);
				$('#referenceProduct').val(data[44]);
