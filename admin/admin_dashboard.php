...
<body>
	...
	<div class="main-container">
		<div class="pd-ltr-20">
			<div class="card-box pl-3 pd-10 height-100-p mb-20 bb-3">
				<div class="row align-items-center">
					...
					<div class="col-md-9">
						...
						<h4 class="font-16 weight-500 mb-10 text-capitalize">
							Welcome back <div class="weight-600 font-20 text-blue"><?php echo $row['FirstName']. " " .$row['LastName']; ?>,</div>
						</h4>
						<p class="font-14 max-width-600">Manage, Create, Update, Delete ...</p>
					</div>
				</div>
			</div>
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								<div class="weight-700 font-24 text-dark"><?php echo($leavecount); ?></div>
								<div class="font-14 text-secondary weight-500">Rejected NPD</div>
							</div>
							<div class="widget-icon">
