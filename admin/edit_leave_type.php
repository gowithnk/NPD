 ...
 if(isset($_POST['edit']))
{
    ...
    $result = mysqli_query($conn,"update tblleavetype set LeaveType='$leavetype', LeaveDays='$leavedays', Description='$description', date_from='$dtefrom', date_to='$dteto' where id = '$get_id' ");
    if ($result) {
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<input name="leavedays" type="text" class="form-control" required="true" 
												autocomplete="off" value="<?php echo $row['LeaveDays']; ?>">
											</div>
										</div>
									</div>
									<div class="row">
